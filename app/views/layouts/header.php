...
<head>
    ...
    <link rel="stylesheet" href="assets/css/components/course-card-dimensions.css?v=4">
    <link rel="stylesheet" href="assets/css/components/course-card-rating-spacing.css?v=1">
