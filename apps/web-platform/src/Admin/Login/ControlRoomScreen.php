...
final class ControlRoomScreen
{
    public static function render(string $action, string $error = '', string $identity = '', int $status = 200): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . '<link rel="stylesheet" href="/room-assets/Admin/Login/page.css?v=20260728-4"></head><body class="control-body">'
            . '<main class="control-shell">'
            . '<section class="control-mark" aria-labelledby="control-heading"><div class="control-brand"><img class="coursehub-control-logo" src="/assets/images/coursehub-robot.svg" alt=""><div><strong>CourseHub</strong><span>Restricted administration</span></div></div>'
