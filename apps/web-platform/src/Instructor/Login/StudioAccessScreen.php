...
final class StudioAccessScreen
{
    public static function render(string $error = '', string $email = '', int $status = 200): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . '<link rel="stylesheet" href="/assets/css/role-auth.css?v=20260728-1"></head><body class="studio-access-body">'
            . '<header class="studio-top"><a class="coursehub-auth-brand" href="/"><img src="/assets/images/coursehub-robot.svg" width="40" height="40" alt=""><span>CourseHub</span><small>Instructor studio</small></a>'
            ...
            . '</div></section>'
            . '<section class="studio-form-wrap"><div class="studio-form-card"><div class="studio-form-brand"><img src="/assets/images/coursehub-robot.svg" width="38" height="38" alt=""><span>Teaching workspace</span></div><header><span>STUDIO SIGN IN</span><h2>Welcome back, Instructor</h2><p>Use the account approved for your CourseHub teaching studio.</p></header>'
            . $errorHtml
            ...
            . '</div></section></main>'
            . '<script src="/assets/js/role-auth.js?v=20260728-1" defer></script></body></html>';
