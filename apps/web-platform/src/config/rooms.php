...
return [
    ...
    'Public/Login' => ['title'=>'Student sign in','path'=>'/login','methods'=>'GET','role'=>'guest','service'=>'identity-service','status'=>'implemented'],
    ...
    'Student/CoursePlayer' => ['title'=>'Course player','path'=>'/student/course-player','methods'=>'GET|POST','role'=>'student','service'=>'learning-service','status'=>'implemented'],
    ...
    'Instructor/CreateCourse' => ['title'=>'Complete course authoring','path'=>'/instructor/courses/create','methods'=>'GET|POST','role'=>'instructor','service'=>'catalog-service','status'=>'implemented'],
    ...
    'Instructor/CurriculumBuilder' => ['title'=>'Curriculum builder','path'=>'/instructor/curriculum','methods'=>'GET|POST','role'=>'instructor','service'=>'catalog-service','status'=>'implemented'],
    'Instructor/Lessons' => ['title'=>'Lessons','path'=>'/instructor/lessons','methods'=>'GET|POST','role'=>'instructor','service'=>'catalog-service','status'=>'implemented'],
    'Instructor/DraftCourses' => ['title'=>'Draft courses','path'=>'/instructor/courses/drafts','methods'=>'GET','role'=>'instructor','service'=>'catalog-service','status'=>'implemented'],
    'Instructor/PendingCourses' => ['title'=>'Pending courses','path'=>'/instructor/courses/pending','methods'=>'GET','role'=>'instructor','service'=>'catalog-service','status'=>'implemented'],
    'Instructor/PublishedCourses' => ['title'=>'Published courses','path'=>'/instructor/courses/published','methods'=>'GET','role'=>'instructor','service'=>'catalog-service','status'=>'implemented'],
    ...
    'Instructor/Sales' => ['title'=>'Sales','path'=>'/instructor/sales','methods'=>'GET','role'=>'instructor','service'=>'reporting-service','status'=>'implemented'],
    ...
    'Instructor/Notifications' => ['title'=>'Notifications','path'=>'/instructor/notifications','methods'=>'GET|POST','role'=>'instructor','service'=>'notification-service','status'=>'implemented'],
    'Instructor/Messaging' => ['title'=>'Messaging','path'=>'/instructor/messaging','methods'=>'GET|POST','role'=>'instructor','service'=>'notification-service','status'=>'implemented'],
    ...
    'Admin/Profile' => ['title'=>'Profile','path'=>'/admin/profile','methods'=>'GET|POST','role'=>'admin','service'=>'identity-service','status'=>'implemented'],
    ...
    'Admin/Withdrawals' => ['title'=>'Withdrawals','path'=>'/admin/withdrawals','methods'=>'GET|POST','role'=>'admin','service'=>'reporting-service','status'=>'implemented'],
    'Admin/Categories' => ['title'=>'Categories','path'=>'/admin/categories','methods'=>'GET|POST','role'=>'admin','service'=>'reporting-service','status'=>'implemented'],
    'Admin/Coupons' => ['title'=>'Coupons','path'=>'/admin/coupons','methods'=>'GET|POST','role'=>'admin','service'=>'reporting-service','status'=>'implemented'],
    'Admin/Reports' => ['title'=>'Reports','path'=>'/admin/reports','methods'=>'GET','role'=>'admin','service'=>'reporting-service','status'=>'implemented'],
    'Admin/AuditLogs' => ['title'=>'Audit logs','path'=>'/admin/audit-logs','methods'=>'GET','role'=>'admin','service'=>'reporting-service','status'=>'implemented'],
    'Admin/Security' => ['title'=>'Security','path'=>'/admin/security','methods'=>'GET|POST','role'=>'admin','service'=>'reporting-service','status'=>'implemented'],
    ...
    'Admin/Notifications' => ['title'=>'Notifications','path'=>'/admin/notifications','methods'=>'GET|POST','role'=>'admin','service'=>'reporting-service','status'=>'implemented'],
];
