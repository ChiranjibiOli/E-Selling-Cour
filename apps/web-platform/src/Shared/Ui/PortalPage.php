...
final class PortalPage
{
    public static function render(string $role, string $title, string $content, string $action = ''): Response
    {
        ...
        $eyebrow = $role === 'instructor'
            ? ''
            : '<span class="portal-eyebrow">' . strtoupper($e($roleName)) . '</span>';
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . '<main class="portal-main"><header class="portal-head"><div>' . $eyebrow . '<h1>' . $e($title) . '</h1><p>' . $e($subtitle) . '</p></div><div class="portal-head-action">' . $action . '</div></header>'
            ...
            . '<div class="portal-toast" data-portal-toast role="status" aria-live="polite"></div><script src="/assets/js/app.js" defer></script><script src="/assets/js/workflow.js" defer></script></body></html>';
