...
final class PortalPage
{
    public static function render(string $role, string $title, string $content, string $action = ''): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . '<div class="portal-stage"><header class="portal-topbar"><div class="portal-crumb"><span>' . $e(ucfirst($role)) . '</span><i>/</i><strong>' . $e($title) . '</strong></div><div class="portal-top-actions"><label class="portal-search"><span>⌕</span><input type="search" placeholder="Search this page" aria-label="Search this page"></label><a class="portal-icon-button" href="/' . $e($role) . '/notifications" aria-label="Notifications"><span>◔</span><i></i></a><span class="portal-top-avatar">' . $e($initials) . '</span></div></header>'
