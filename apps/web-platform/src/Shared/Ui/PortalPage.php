...
final class PortalPage
{
    public static function render(string $role, string $title, string $content, string $action = ''): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . '<div class="portal-sidebar-foot"><a href="/contact"><span class="portal-nav-icon">?</span><span>Help & support</span></a><div class="portal-sidebar-user"><span class="portal-avatar">' . $e($initials) . '</span><div><strong>' . $e($name) . '</strong><small>' . $e($email !== '' ? $email : ucfirst($role)) . '</small></div><button type="button" aria-label="Account menu">•••</button></div></div></aside>'
    ...
    private static function navigation(string $role): array
    {
        return match ($role) {
            'admin' => [
                'Workspace' => [
                    '/admin/dashboard' => ['Overview', 'OV'],
                    '/admin/notifications' => ['Notifications', 'NT'],
                ],
                'People' => [
                    '/admin/instructor-approvals' => ['Instructor approvals', 'IA'],
                    '/admin/students' => ['Students', 'ST'],
                    '/admin/instructors' => ['Instructors', 'IN'],
                    '/admin/users' => ['All users', 'US'],
                ],
                'Learning' => [
                    '/admin/course-approvals' => ['Course approvals', 'CA'],
                    '/admin/categories' => ['Categories', 'CT'],
                    '/admin/enrollments' => ['Enrollments', 'EN'],
                ],
                'Commerce' => [
                    '/admin/orders' => ['Orders', 'OR'],
                    '/admin/payments' => ['Payments', 'PY'],
                    '/admin/refunds' => ['Refunds', 'RF'],
                    '/admin/withdrawals' => ['Withdrawals', 'WD'],
                    '/admin/coupons' => ['Coupons', 'CP'],
                ],
                'Operations' => [
                    '/admin/reports' => ['Reports', 'RP'],
                    '/admin/contact-messages' => ['Messages', 'MS'],
                    '/admin/audit-logs' => ['Audit logs', 'AL'],
                    '/admin/security' => ['Security', 'SC'],
                    '/admin/settings' => ['Settings', 'SE'],
                ],
            ],
            'instructor' => [
                'Workspace' => [
                    '/instructor/dashboard' => ['Overview', 'OV'],
                    '/instructor/verification-pending' => ['Verification', 'VR'],
                    '/instructor/notifications' => ['Notifications', 'NT'],
                    '/instructor/messaging' => ['Messages', 'MS'],
                ],
                'Courses' => [
                    '/instructor/courses' => ['All courses', 'CR'],
                    '/instructor/courses/create' => ['Create course', 'NW'],
                    '/instructor/courses/drafts' => ['Drafts', 'DR'],
                    '/instructor/courses/pending' => ['Pending review', 'PN'],
                    '/instructor/courses/published' => ['Published', 'PB'],
                    '/instructor/curriculum' => ['Curriculum', 'CU'],
                    '/instructor/lessons' => ['Lessons', 'LS'],
                ],
                'Business' => [
                    '/instructor/students' => ['Students', 'ST'],
                    '/instructor/sales' => ['Sales', 'SL'],
                    '/instructor/coupons' => ['Coupons', 'CP'],
                    '/instructor/withdrawals' => ['Withdrawals', 'WD'],
                    '/instructor/bank-details' => ['Payout details', 'BK'],
                ],
                'Account' => [
                    '/instructor/profile' => ['Profile', 'PR'],
                ],
            ],
            default => [
                'Learning' => [
                    '/student/dashboard' => ['Overview', 'OV'],
                    '/student/my-courses' => ['My courses', 'CR'],
                    '/student/course-player' => ['Course player', 'PL'],
                    '/student/progress' => ['Progress', 'PG'],
                ],
                'Purchases' => [
                    '/student/cart' => ['My cart', 'CT'],
                    '/student/checkout' => ['Checkout', 'CK'],
                    '/student/payment' => ['Payment', 'PY'],
                    '/student/payment-history' => ['Payment history', 'PH'],
                ],
                'Account' => [
                    '/student/notifications' => ['Notifications', 'NT'],
                    '/student/reviews' => ['My reviews', 'RV'],
                    '/student/unsubscribe' => ['Access requests', 'AR'],
                    '/student/profile' => ['Profile', 'PR'],
                ],
            ],
        };
    }
