...
final class StudentLoginScreen
{
    public static function render(string $error = '', string $email = '', int $status = 200): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . '<link rel="stylesheet" href="/assets/css/app.css"><link rel="stylesheet" href="/assets/css/public-site.css?v=20260728-2"><link rel="stylesheet" href="/assets/css/role-auth.css?v=20260728-1">' . PublicNavbar::styles()
            ...
            . '<div class="student-login-card-mark"><img src="/assets/images/coursehub-robot.svg" width="38" height="38" alt=""><span>Student portal</span></div>'
            ...
            . '</div></section></main>'
            . PublicNavbar::script() . '<script src="/assets/js/role-auth.js?v=20260728-1" defer></script></body></html>';
