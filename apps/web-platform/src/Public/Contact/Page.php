...
final class PublicContactPage
{
    public static function render(array $values = [], string $message = '', bool $success = true): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#f7f0e5"><title>Contact CourseHub</title>'
            ...
            . '<nav class="public-site-links" aria-label="Public navigation"><a href="/">Home</a><a href="/courses">Courses</a><a href="/#categories">Categories</a><a href="/about">About</a><a class="active" href="/contact">Contact</a></nav>'
            ...
            . '<footer class="catalog-footer"><a href="/">CourseHub</a><span>Support without mystery.</span></footer><script src="/assets/js/public-site.js?v=20260728-1" defer></script></body></html>';
