...
final class ForgotPasswordPage
{
    public static function render(array $values = [], string $message = '', bool $success = false): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            . '<title>Student password recovery | CourseHub</title><link rel="stylesheet" href="/assets/css/app.css"><link rel="stylesheet" href="/room-assets/Public/AuthRecovery/page.css"></head>'
            ...
            . '<button type="submit">Send six-digit code</button></form><p class="form-foot"><a href="/learn/sign-in">← Return to Student sign in</a></p></section></main></body></html>';
