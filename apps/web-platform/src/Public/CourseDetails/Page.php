...
final class CourseDetailsPage
{
    public static function render(CourseDetailsViewModel $model): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#f7f0e5"><title>' . $e($course['title'] ?? 'Course') . ' | CourseHub</title>'
            ...
            . '<link rel="stylesheet" href="/room-assets/Public/CourseDetails/page.css"><link rel="stylesheet" href="/assets/css/public-site.css?v=20260728-1"></head><body class="detail-body">'
            ...
            . '</main><footer class="detail-footer"><a href="/">CourseHub</a><span>Education that moves with you.</span></footer><script src="/assets/js/public-site.js?v=20260728-1" defer></script></body></html>';
