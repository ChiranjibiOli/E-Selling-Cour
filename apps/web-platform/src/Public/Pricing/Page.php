...
<main>
    ...
    <section class="pricing-model">
        <article class="pricing-featured"><span>THE STANDARD MODEL</span><h2>One-time course purchase</h2><strong>Course-specific price</strong><p>The exact amount is displayed on the course page. The server recalculates the price, discount, and payable total during checkout.</p><ul><li>Lifetime access after verified payment</li><li>Progress and purchased-course history</li><li>Verified review eligibility</li><li>No unrelated courses unlocked</li></ul><a href="/courses">Choose a course</a></article>
        <div class="pricing-side">
            <article><span>FREE COURSES</span><h3>NPR 0</h3><p>A zero-total order creates a recorded enrollment without requiring a fake payment screenshot.</p></article>
            <article><span>DISCOUNTS</span><h3>Validated server-side</h3><p>Coupons must be active, eligible, within their usage limit, and valid for the selected course.</p></article>
            <article><span>REFUNDS</span><h3>Separate decision</h3><p>Removing access does not automatically create a refund. Financial reversal follows the published refund policy.</p></article>
        </div>
    </section>
    ...
    <section class="pricing-methods">
        <div class="pricing-section-heading"><span>PAYMENT METHODS</span><h2>Designed for Nepal, enabled only when properly configured.</h2></div>
