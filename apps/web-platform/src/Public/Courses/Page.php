...
final class CourseCatalogPage
{
    public static function render(CourseCatalogViewModel $model): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Explore courses | CourseHub</title>'
            . '<link rel="stylesheet" href="/assets/css/app.css"><link rel="stylesheet" href="/room-assets/Public/Courses/page.css"><link rel="stylesheet" href="/assets/css/course-card-theme.css"></head><body class="catalog-body">'
            . '<header class="catalog-header"><a href="/">CourseHub</a><nav><a class="active" href="/courses">Courses</a><a href="/about">About</a></nav><a class="catalog-signin" href="/login">Sign in</a></header>'
            ...
            . '<footer class="catalog-footer"><a href="/">CourseHub</a><span>Learn carefully. Build properly.</span></footer><script src="/assets/js/course-card-theme.js" defer></script></body></html>';
