...
final class CourseCatalogPage
{
    public static function render(CourseCatalogViewModel $model): Response
    {
        ...
        $html = '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#f7f0e5"><title>Explore courses | CourseHub</title>'
            ...
            . '<nav class="public-site-links" aria-label="Public navigation"><a href="/">Home</a><a class="active" href="/courses">Courses</a><a href="/#categories">Categories</a><a href="/about">About</a><a href="/contact">Contact</a></nav>'
            ...
            . '<footer class="catalog-footer"><a href="/">CourseHub</a><span>Education that moves with you.</span></footer><script src="/assets/js/public-site.js?v=20260728-1" defer></script><script src="/assets/js/course-card-theme.js" defer></script></body></html>';
